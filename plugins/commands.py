...
from okmj.utils.file_properties import get_name, get_hash, get_media_file_size
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 ᴊᴏɪɴ ᴏᴜʀ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Crunchyroll_Anime_Updates')
            ],[
            InlineKeyboardButton('🔍 🇷​​🇪​​🇶​​🇺​​🇪​​🇸​​🇹​ ​🇲​​🇴​​🇻​​🇮​​🇪​​🇸​', url='https://t.me/RequestMoviesSeries'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Crunchyroll_Anime_Update')
            ],[
